...
class WidgetStateTest {
    ...
    fun `InboxCountWidget can be instantiated`() {
        val widget = io.inkwell.widget.InboxCountWidget()
        assertNotNull(widget)
    }

    @Test
    fun `QuickCaptureWidget can be instantiated`() {
        val widget = io.inkwell.widget.QuickCaptureWidget()
        assertNotNull(widget)
    }

    @Test
    fun `InboxCountWidgetReceiver can be instantiated`() {
        val receiver = io.inkwell.widget.InboxCountWidgetReceiver()
        assertNotNull(receiver)
    }

    @Test
    fun `QuickCaptureWidgetReceiver can be instantiated`() {
        val receiver = io.inkwell.widget.QuickCaptureWidgetReceiver()
        assertNotNull(receiver)
    }
