...
import io.inkwell.data.remote.dto.InboxItem
import io.inkwell.data.remote.dto.InboxResponse
...
import io.inkwell.sync.SyncWorker
...
class SyncWorkerIntegrationTest {
    ...
    fun setup() {
        ...
        mockkObject(io.inkwell.widget.WidgetStateUpdater)
        coEvery { io.inkwell.widget.WidgetStateUpdater.updateCounts(any(), any(), any()) } returns Unit
    }
