 ...
 * - `inkwell://` — custom scheme (backward compat, kept for existing links)
 * - `https://tyler-capture.duckdns.org/app/` — verified App Links (cannot be intercepted)
 */
object DeepLink {
    const val SCHEME = "inkwell"
     ...
     * Handles both `inkwell://` and `https://tyler-capture.duckdns.org/app/` URIs.
    ...
    fun parseToRoute(uri: Uri?): String? {
        ...
        // Custom scheme: inkwell://<destination>
