    ...
    suspend fun authenticate(activity: FragmentActivity): Boolean {
        return suspendCancellableCoroutine { continuation ->
            ...
            val promptInfo = BiometricPrompt.PromptInfo.Builder()
                .setTitle(activity.getString(io.inkwell.R.string.biometric_prompt_title))
                .setSubtitle(activity.getString(io.inkwell.R.string.biometric_prompt_subtitle))
